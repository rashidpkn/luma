...
export default function Preloader({
  ...
  return (
    <div
      className={`fixed inset-0 w-[100dvw] h-[100dvh] z-[99999] flex flex-col items-center justify-center bg-[#2580E8] cursor-pointer select-none touch-none overflow-hidden transition-all duration-500 ease-out ${stage === "exit"
        ? "opacity-0 scale-102 pointer-events-none blur-sm"
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden flex items-center justify-center">
        ...
        <div
          className={`w-[680px] h-[680px] rounded-full blur-[130px] transition-all duration-500 ${stage === "unified"
            ? "bg-gradient-to-tr from-[#3805F6]/30 via-[#38bdf8]/40 to-[#08DBFF]/35 scale-125"
            : stage === "p-trace"
              ? "bg-gradient-to-r from-[#3805F6]/25 to-[#38bdf8]/30 scale-110"
              : "bg-gradient-to-b from-[#3805F6]/25 to-[#7dd3fc]/25 scale-100"
            }`}
        />
        {/* Concentric subtle radar rings */}
        <div
          className={`absolute w-[440px] h-[440px] rounded-full border border-white/20 blur-sm transition-all duration-700 ${stage === "unified" ? "scale-140 opacity-40" : "scale-100 opacity-20"
            }`}
        />
      </div>
