...
export const Footer: React.FC = () => {
  ...
  return (
    <footer data-logo-color="black">
      ...
      <div className="row footer-legal-row" style={{ marginTop: '40px', paddingTop: '30px', borderTop: '1px solid rgba(12,108,229,0.1)' }}>
        <div className="xxlarge-16 columns">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', fontSize: '13px', lineHeight: '1.6', color: '#475569' }}>
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                ...
                />
                <span style={{ color: 'rgba(12,108,229,0.2)' }}>|</span>
                <p style={{ fontWeight: 500, color: '#64748b', margin: 0, fontSize: '13px' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', fontSize: '13px' }}>
                ...
                <Link to="/terms-of-service" style={{ color: '#475569', textDecoration: 'none' }}>Terms of Service</Link>
                <Link to="/regulatory-disclosures" style={{ color: '#475569', textDecoration: 'none' }}>Regulatory Disclosures</Link>
                <Link to="/information-security-policy" style={{ color: '#475569', textDecoration: 'none' }}>Security Policy</Link>
                <Link to="/aml-kyc-policy" style={{ color: '#475569', textDecoration: 'none' }}>AML / Compliance</Link>
                <Link to="/acceptable-use-policy" style={{ color: '#475569', textDecoration: 'none' }}>Acceptable Use</Link>
                <a href="mailto:support@luma-pay.io" style={{ color: '#0c6ce5', textDecoration: 'none' }}>support@luma-pay.io</a>
              </div>
            </div>
