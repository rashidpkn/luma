    ...
    >
      <style>{`
        .block-save-time {
          ...
          background: radial-gradient(circle at 25% 50%, rgba(14, 165, 233, 0.12) 0%, transparent 60%), #020617;
          position: relative;
        }
                ...
                <span className="title-line-1">
                  ...
                  >
                    <path
                      ...
                      fill="#38bdf8"
                    />
                    <path d="M28.0336 7.56836H10.3633V9.67169H28.0336V7.56836Z" fill="#38bdf8" />
                    <path d="M22.9862 17.6533H10.3633V19.7567H22.9862V17.6533Z" fill="#38bdf8" />
                    <path d="M20.458 12.6108H10.3633V14.7142H20.458V12.6108Z" fill="#38bdf8" />
                    <path
